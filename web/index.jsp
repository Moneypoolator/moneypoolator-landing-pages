        ...
        <div id="container">
            ...
            <div id="content">
                <div id="main">
                    ...
                    <p>Это рынок предсказаний. Здесь вы сможете выбрать конкретный вариант будущего &mdash; например тот, в котором какая-нибудь страна объявит дефолт, &mdash; и заработать на этом. А кроме того, на <a class="a" href="#">Moneypoolator</a> можно будет узнать, произойдет интересующее вас событие или нет.</p>
                    <div id="use">
