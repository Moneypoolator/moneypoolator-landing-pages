...
<head>
<meta charset="utf-8" />
<title>Moneypoolator - Глобальный рынок прогнозов</title>
...
<body>
	...
	<div id="container-header2">
		<header>
			<div id="logo"><a href="/"><img src="<c:url value="/_img3/logo2.png"/>" alt="Moneypoolator - Глобальный рынок прогнозов" /></a></div>
			<div id="header-right">
