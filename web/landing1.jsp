    ...
    <body>
        ...
        <div id="container">
            <header>
                ...
                <div id="opening"></div>
                <div id="header-info">
                    <h2>Как заработать<br />на прогнозе курса доллара?</h2>
            ...
            <div id="content">
                <div id="main">
                    ...
                    <p>Это рынок предсказаний. Здесь вы сможете выбрать конкретный вариант будущего &mdash; например тот, в котором доллар стоит 35 рублей, &mdash; и заработать на этом. А кроме того, на Moneypoolator можно будет узнать, произойдет интересующее вас событие или нет.</p>
